...
bool zaap::CheckZaapLinde()
{
    ...
    if ((int(GetRValue(color1)) < I_AM_IN_LINDE_ZAAP_COLOR_RED_1   + ERROR_GET_COLOUR_QUITE) &&
        (int(GetRValue(color1)) > I_AM_IN_LINDE_ZAAP_COLOR_RED_1   - ERROR_GET_COLOUR_QUITE) &&
        (int(GetGValue(color1)) < I_AM_IN_LINDE_ZAAP_COLOR_GREEN_1 + ERROR_GET_COLOUR_QUITE) &&
        (int(GetGValue(color1)) > I_AM_IN_LINDE_ZAAP_COLOR_GREEN_1 - ERROR_GET_COLOUR_QUITE) &&
        (int(GetBValue(color1)) < I_AM_IN_LINDE_ZAAP_COLOR_BLUE_1  + ERROR_GET_COLOUR_QUITE) &&
        (int(GetBValue(color1)) > I_AM_IN_LINDE_ZAAP_COLOR_BLUE_1  - ERROR_GET_COLOUR_QUITE)
        &&
        (int(GetRValue(color2)) < I_AM_IN_LINDE_ZAAP_COLOR_RED_2   + ERROR_GET_COLOUR_QUITE) &&
        (int(GetRValue(color2)) > I_AM_IN_LINDE_ZAAP_COLOR_RED_2   - ERROR_GET_COLOUR_QUITE) &&
        (int(GetGValue(color2)) < I_AM_IN_LINDE_ZAAP_COLOR_GREEN_2 + ERROR_GET_COLOUR_QUITE) &&
        (int(GetGValue(color2)) > I_AM_IN_LINDE_ZAAP_COLOR_GREEN_2 - ERROR_GET_COLOUR_QUITE) &&
        (int(GetBValue(color2)) < I_AM_IN_LINDE_ZAAP_COLOR_BLUE_2  + ERROR_GET_COLOUR_QUITE) &&
        (int(GetBValue(color2)) > I_AM_IN_LINDE_ZAAP_COLOR_BLUE_2  - ERROR_GET_COLOUR_QUITE)
        &&
        (int(GetRValue(color3)) < I_AM_IN_LINDE_ZAAP_COLOR_RED_3   + ERROR_GET_COLOUR_QUITE) &&
        (int(GetRValue(color3)) > I_AM_IN_LINDE_ZAAP_COLOR_RED_3   - ERROR_GET_COLOUR_QUITE) &&
        (int(GetGValue(color3)) < I_AM_IN_LINDE_ZAAP_COLOR_GREEN_3 + ERROR_GET_COLOUR_QUITE) &&
        (int(GetGValue(color3)) > I_AM_IN_LINDE_ZAAP_COLOR_GREEN_3 - ERROR_GET_COLOUR_QUITE) &&
        (int(GetBValue(color3)) < I_AM_IN_LINDE_ZAAP_COLOR_BLUE_3  + ERROR_GET_COLOUR_QUITE) &&
        (int(GetBValue(color3)) > I_AM_IN_LINDE_ZAAP_COLOR_BLUE_3  - ERROR_GET_COLOUR_QUITE)
        )
    {
...
bool zaap::CheckZaapKani()
{
    bool ret = false;

    COLORREF color1 = basicOperations::GetColor(I_AM_IN_KANI_ZAAP_POS_X_1, I_AM_IN_KANI_ZAAP_POS_Y_1, true);
    COLORREF color2 = basicOperations::GetColor(I_AM_IN_KANI_ZAAP_POS_X_2, I_AM_IN_KANI_ZAAP_POS_Y_2, true);

    if ((int(GetRValue(color1)) < I_AM_IN_KANI_ZAAP_COLOR_RED_1   + ERROR_GET_COLOUR_SMALL) &&
        (int(GetRValue(color1)) > I_AM_IN_KANI_ZAAP_COLOR_RED_1   - ERROR_GET_COLOUR_SMALL) &&
        (int(GetGValue(color1)) < I_AM_IN_KANI_ZAAP_COLOR_GREEN_1 + ERROR_GET_COLOUR_SMALL) &&
        (int(GetGValue(color1)) > I_AM_IN_KANI_ZAAP_COLOR_GREEN_1 - ERROR_GET_COLOUR_SMALL) &&
        (int(GetBValue(color1)) < I_AM_IN_KANI_ZAAP_COLOR_BLUE_1  + ERROR_GET_COLOUR_SMALL) &&
        (int(GetBValue(color1)) > I_AM_IN_KANI_ZAAP_COLOR_BLUE_1  - ERROR_GET_COLOUR_SMALL)
        &&
        (int(GetRValue(color2)) < I_AM_IN_KANI_ZAAP_COLOR_RED_2   + ERROR_GET_COLOUR_SMALL) &&
        (int(GetRValue(color2)) > I_AM_IN_KANI_ZAAP_COLOR_RED_2   - ERROR_GET_COLOUR_SMALL) &&
        (int(GetGValue(color2)) < I_AM_IN_KANI_ZAAP_COLOR_GREEN_2 + ERROR_GET_COLOUR_SMALL) &&
        (int(GetGValue(color2)) > I_AM_IN_KANI_ZAAP_COLOR_GREEN_2 - ERROR_GET_COLOUR_SMALL) &&
        (int(GetBValue(color2)) < I_AM_IN_KANI_ZAAP_COLOR_BLUE_2  + ERROR_GET_COLOUR_SMALL) &&
        (int(GetBValue(color2)) > I_AM_IN_KANI_ZAAP_COLOR_BLUE_2  - ERROR_GET_COLOUR_SMALL)
        )
    {
        File::LogFile("I'm in Kani  Zaap! ", true);
        ret = true;
    }
...
bool zaap::CheckZaapPueblo()
{
    bool ret = false;

    COLORREF color1 = basicOperations::GetColor(I_AM_IN_PUEBLO_ZAAP_POS_X_1, I_AM_IN_PUEBLO_ZAAP_POS_Y_1, true);
    COLORREF color2 = basicOperations::GetColor(I_AM_IN_PUEBLO_ZAAP_POS_X_2, I_AM_IN_PUEBLO_ZAAP_POS_Y_2, true);

    if ((int(GetRValue(color1)) < I_AM_IN_PUEBLO_ZAAP_COLOR_RED_1   + ERROR_GET_COLOUR_SMALL) &&
        (int(GetRValue(color1)) > I_AM_IN_PUEBLO_ZAAP_COLOR_RED_1   - ERROR_GET_COLOUR_SMALL) &&
        (int(GetGValue(color1)) < I_AM_IN_PUEBLO_ZAAP_COLOR_GREEN_1 + ERROR_GET_COLOUR_SMALL) &&
        (int(GetGValue(color1)) > I_AM_IN_PUEBLO_ZAAP_COLOR_GREEN_1 - ERROR_GET_COLOUR_SMALL) &&
        (int(GetBValue(color1)) < I_AM_IN_PUEBLO_ZAAP_COLOR_BLUE_1  + ERROR_GET_COLOUR_SMALL) &&
        (int(GetBValue(color1)) > I_AM_IN_PUEBLO_ZAAP_COLOR_BLUE_1  - ERROR_GET_COLOUR_SMALL)
        &&
        (int(GetRValue(color2)) < I_AM_IN_PUEBLO_ZAAP_COLOR_RED_2   + ERROR_GET_COLOUR_SMALL) &&
        (int(GetRValue(color2)) > I_AM_IN_PUEBLO_ZAAP_COLOR_RED_2   - ERROR_GET_COLOUR_SMALL) &&
        (int(GetGValue(color2)) < I_AM_IN_PUEBLO_ZAAP_COLOR_GREEN_2 + ERROR_GET_COLOUR_SMALL) &&
        (int(GetGValue(color2)) > I_AM_IN_PUEBLO_ZAAP_COLOR_GREEN_2 - ERROR_GET_COLOUR_SMALL) &&
